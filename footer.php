...
<footer class="bg-gradient-to-b from-white to-gray-300 dark:bg-gradient-to-b dark:from-gray-700 dark:to-black text-center w-full fixed bottom-0">
  


  <!--newsletter-->
  <div class="container max-w-lg pt-8 mx-auto">
    <form action="">
  ...
  <div class="container page-section mx-auto grid md:grid-cols-4 gird-cols-1 gap-4 pb-8 pt-8 md:p-4">
    ...
    <div class="border-b border-gray-300 pb-6 sm:border-b sm:border-gray-300 md:border-none md:text-left lg:pl-20">
     ...
     <?php wp_nav_menu( array(
        ...
        'add_li_class'         => 'hover:text-blue-500',
  ...
  <inline class="dark:text-white">&copy; <?php echo date("Y"); ?> -  <?php echo $company_name; ?></inline> 
      <br>
    <a class="text-gray-400  text-base font-medium hover:text-blue-500" href="tel:<?php echo $tel_number; ?>">
    <?php echo $tel_number; ?></a>
  

  <div class="pt-8">
    <div class="flex justify-center">
      <a href="#!" class="mr-9 text-gray-500 hover:text-blue-600 hover:scale-125">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a href="#!" class="mr-9 text-gray-500 hover:text-blue-400 hover:scale-125">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a href="#!" class="mr-9 text-gray-500 hover:text-red-600 hover:scale-125">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a href="#!" class="mr-9 text-gray-500 hover:text-orange-600 hover:scale-125">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a href="#!" class="text-gray-500 hover:text-black hover:scale-125 dark:hover:text-orange-500">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
